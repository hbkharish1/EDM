...
<div id="content" class="app-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-10">
                        ...
                        <h1 class="page-header">
                            Senior Financing Details <small>Manage site users.</small>
                        </h1>
    ...
    <tbody>
      <tr>
        ...
        <td><h6>:  {{$ml->name_of_bank}}</h6></td>
      </tr>
      <tr>
        <td><h6>WEBSITE</h6></td>
        <td><h6>:  {{$ml->website}}</h6></td>
      </tr>
      <tr>
        <td><h6>BORROWER FINANCE</h6></td>
        <td><h6>:  {{$ml->borrowers_finance}}</h6></td>
      </tr>
      <tr>
        <td><h6>PROJECT DEVELOPER</h6></td>
        <td><h6>:  {{$ml->project_developer_permit}}</h6></td>
      </tr>
      <tr>
        <td><h6>CONTACT NO</h6></td>
        <td><h6>:  {{$ml->phone}}</h6></td>
      </tr>
    </tbody>
  </table>
