...
<div id="content" class="app-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-10">
                        ...
                        <h1 class="page-header">
                            Mezzanine Details <small>Manage site users.</small>
                        </h1>
    ...
    <tbody>
      <tr>
        <td><h6>NAME OF THE BANK</h6></td>
        <td><h6>:  {{$mezzanine->name}}</h6></td>
      </tr>
      <tr>
        <td><h6>WEBSITE</h6></td>
        <td><h6>:  {{$mezzanine->website}}</h6></td>
      </tr>
      <tr>
        <td><h6>BORROWER FINANCE</h6></td>
        <td><h6>:  {{$mezzanine->borrower_domiciled}}</h6></td>
      </tr>
      <tr>
        <td><h6>PROJECT DEVELOPER</h6></td>
        <td><h6>:  {{$mezzanine->project_developer_permit}}</h6></td>
      </tr>
      <tr>
        <td><h6>CONTACT NO</h6></td>
        <td><h6>:  {{$mezzanine->phone}}</h6></td>
      </tr>
    </tbody>
  </table>
