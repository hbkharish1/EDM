                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row align-items-center justify-content-center">
                            <form class="cmxform col-12 col-md-9 m-0" id="importExcel" action="{{ route('uploadExcel') }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                               <div class="row align-items-center justify-content-center">
                            ...
                            {!! $errors->first('file1', '<p class="mb-2 errorMsg">Unsupported File Format, please select .xlsx or .csv file</p>') !!}
                            <a href = "{{route('downloadQuestionnaire')}}" class="my-2 btn btn-primary col-12 col-md-4 excel_btn">Download Datatbase</a>
                        </div>
                                                ...
                                                <td>
                                                    <div class="dropdown bank-table-dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="{{ route('Senior_',$user->id)}}" class="dropdown-item"><i
                                                                    class="fas fa-lg fa-fw  fa-eye"></i> View</a>
                                                            <a href="{{ route('editdata',$user->id)}}" class="dropdown-item"><i
